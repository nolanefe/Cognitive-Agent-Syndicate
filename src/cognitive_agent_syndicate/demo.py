...
def create_demo_provider(*, per_stage_usage: UsageMetrics | None = None) -> MockModelProvider:
    ...
    _configure_url_shortener_responses(provider)
    return provider


def _configure_url_shortener_responses(provider: MockModelProvider) -> None:
